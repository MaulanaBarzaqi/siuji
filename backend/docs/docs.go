...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.SetupCredentialRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Credential setup successful",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "Bad request / setup failed",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
    ...
    "definitions": {
        ...
        "controllers.SetupCredentialRequest": {
            "type": "object",
            "properties": {
                "confirm_new_password": {
                    "type": "string"
